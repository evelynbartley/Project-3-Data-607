...
We divided this question into two parts–hard skills and soft skills-and analyzed each separately. The "value" of a skill was defined as the frequency of its occurrence (ie, a skill that is mentioned many times in a dataset would be a highly valued skill).
...
The map shows that although survey responses were received from 91 countries, most responders were from the US. Countries without any survey responses are shown in gray.
...
The mean annual compensation was 117,833 USD.
